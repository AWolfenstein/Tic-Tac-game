...
void startProgramm() {
	...
	case 3:
		...
		break;
	default:
		cout << "Error, bad input, repeat" << endl;
		startProgramm();
		break;
	}
	if (done == USER) {
		system("cls"); cout << "You won!:(" << endl;
	}
	else if (done == COMPUTER) {
		system("cls"); cout << "I won!HaAHHA!!!" << endl;
	}
	else {
		system("cls"); cout << "DRAW!HaHAHa" << endl;
	}
	disp_matrix();
	returnToMenu();
}
